...
/*
Esse é um jogo da velha simples em modo texto. Ele utiliza uma matriz 3x3 para representar o tabuleiro e permite que dois jogadores joguem alternadamente ('X' e 'O') até que alguém vença ou ocorra empate. Para realizar uma jogada, o jogador deve digitar a linha e a coluna da posição em que deseja colocar sua marca. O jogo exibirá o tabuleiro após cada jogada e mostrará o vencedor ou indicará empate quando necessário.
*/
public class Main {
